...
<template>
  <div class="drawer lg:drawer-open">
    ...
    <div class="drawer-content">
      <nav class="navbar w-full bg-base-100/10 backdrop-blur-xl">
        <label
          for="my-drawer-4"
        ...
        <div @click="selectedFolder = 'all'" class="btn btn-ghost pl-3 mr-auto">
          ...
          <div class="flex items-start gap-4">
            ...
            <div>
              ...
              >
                ...
                seront supprimés. Leurs notes seront conservées dans « Sans
                dossier ».
              </p>
            </div>
          </div>
    ...
    <div class="drawer-side is-drawer-close:overflow-visible border-r">
      <div
        class="flex min-h-full flex-col items-start bg-base-100 is-drawer-close:w-14 is-drawer-open:w-64"
      >
        <!-- Sidebar content here -->

        <div class="flex items-center justify-center gap-2 mt-2 px-2 w-full">
          <div
            @click="selectedFolder = 'all'"
            class="btn btn-ghost is-drawer-close:hidden pl-3 mr-auto"
          >
            <u-icon name="lucide:lightbulb" class="size-5" />
